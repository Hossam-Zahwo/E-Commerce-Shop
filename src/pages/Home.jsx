...
function Home({view,theme,setTheme,detail , close,setClose,AddtoCart,LiksProducts}) {
  const products =[
    {
      id:1,
      image:"../../public/all-nova-12i.png" ,
      title:'23 products'
    },
    {
      id:2,
      image:"../../public/LENOVO-V15-G4-Laptop.png" ,
      title:'23 products'
    },
    {
      id:3,
      image:"../../public/png-clipart-apple-watch-apple-watch-white-removebg-preview.png" ,
      title:'23 products'
    },
    {
      id:4,
      image:"../../public/png-transparent-television-set-led-backlit-lcd-aoc-international-smart-tv-led-miscellaneous-television-rectangle-removebg-preview.png" ,
      title:'23 products'
    },
