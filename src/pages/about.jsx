...
function About({ theme }) {
  return (
    <div className={`mt-[180px]  h-full p font-sans border-box ${theme === 'dark' ? 'bg-black text-white' : 'bg-white text-black'}`}>
      <div className=' h-[800px] py-56 w-full flex justify-center items-center  bg-[url("/public/images/akrales_190919_3670_0074.jpg")] bg-center bg-cover bg-no-repeat  bg-fixed container:m-0'>
